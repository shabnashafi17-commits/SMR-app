...
class UserTaskdetailspage extends StatelessWidget {
  final Reminder reminder;
  final String? taskText;
  final String? taskVoice;
  final int index;
  const UserTaskdetailspage({super.key,this.taskText,this.taskVoice,required this.reminder,required this.index});
                ...
                child: Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          //         Row(
                          //           // children: [
                          //           //   DatePickerContainer(reminderId: reminder.id),
                          //           //   // SizedBox(width: 12),
                          //           //   TimePickerContainer(reminderId: reminder.id),
                          //           // ],
                          //         ),
                          //
                          //
